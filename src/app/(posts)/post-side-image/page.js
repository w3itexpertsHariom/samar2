    ...
    return(
        <>
            ...
            <div className="page-content bg-white">
                <CommanTitle bgimg={ThemeImage.BannerBg1} cappageTitle={"SIDE IMAGE"} maintitle={"Home"} pagetitle={"Post Side Image"} />
                                ...
                                <div className="dlab-blog blog-single style-1 sidebar">
                                    <div className="dlab-info">
                                        ...
                                        <div className="dlab-post-text text">
                                            <div className="alignleft w-50 rounded-md shadow overflow-hidden">
                                                <Image src={ThemeImage.OurBlogPic1} alt="blog" />
                                            </div>
                                            ...
                                            <ul className="wp-block-gallery columns-3">
                                                <li className="blocks-gallery-item"><Image alt="blogpic2" src={ThemeImage.OurBlogPic2} /></li>
                                                <li className="blocks-gallery-item"><Image alt="blogpic1" src={ThemeImage.OurBlogPic1} /></li>
                                            </ul>
