    ...
    return(
        <>
            ...
            <div className="page-content bg-white">
                <CommanTitle bgimg={ThemeImage.BannerBg1} cappageTitle={"POST LINK"} maintitle={"Home"} pagetitle={"Post Link"} />
                            ...
                            <div className="col-xl-8 col-lg-8 m-b50">                                
                                <div className="dlab-blog blog-single style-1 sidebar">
                                    <div className="dlab-media rounded-md shadow ">
                                        ...
                                        <Link href="https://www.google.com" className="post-link-in">https://www.google.com</Link>
                                    </div>
