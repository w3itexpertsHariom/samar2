...
export default function PostGalleryAlternative(){
    return(
        <>
            <Header />
            <div className="page-content bg-white">
                <CommanTitle bgimg={ThemeImage.BannerBg1} cappageTitle={"GALLERY ART"} pagetitle={"Post Gallery Alternative"} maintitle={"Home"} />
                                    ...
                                    <div className="dlab-info">
                                        <div className="dlab-meta border-0 py-0 mb-2">
                                            <ul className="border-0">
                                                <li className="post-date"><i className="flaticon-clock m-r10" />7 March, 2024</li>
                                        ...
                                        <div className="dlab-post-text text">
                                            <ul className="wp-block-gallery columns-3">
                                                <li className="blocks-gallery-item"><Image alt="blog3" src={ThemeImage.OurBlogPic3}/></li>
                                                <li className="blocks-gallery-item"><Image alt="blog4" src={ThemeImage.OurBlogPic4}/></li>
